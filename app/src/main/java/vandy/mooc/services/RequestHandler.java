...
class RequestHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        // TODO -- you fill in here.
        final String directoryPathname = requestMessage.getImagePathname();
        ...
        final Runnable downloadImageAndReply = 
            new Runnable() {
                ...
                public void run() {
                    ...
                    // TODO -- you fill in here.
                    Uri imageUri = Utils.downloadImage(mService.get().getApplicationContext(), url, directoryPathname);

                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -- you fill in here.
                    sendPath(replyMessenger, imageUri, url, requestCode);
